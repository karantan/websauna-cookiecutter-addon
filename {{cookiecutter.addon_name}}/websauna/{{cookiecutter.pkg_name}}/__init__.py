...
class AddonInitializer:
    ...
    * For something we don't have a direct join point we just initialize through ``run()``
    ...
    def configure_templates(self):
        ...
        self.config.add_jinja2_search_path('websauna.{{cookiecutter.pkg_name}}:templates', name='.html', prepend=False)  # HTML templates for pages
...
def includeme(config: Configurator):
    ...
    In the Initializer of your app you should have:
        ...
        def include_addons(self):
            # ...
            self.config.include("websauna.{{cookiecutter.pkg_name}}")
